...
const VerifyTokenComponent = () => {
  ...
  return (
    <div
      className={
        theme !== "light"
          ? "dark dark:bg-gray-900 dark:text-white bg-white text-black container h-screen w-full  justify-center items-start  flex m-auto"
          : "light light:bg-gray-100 light:text-black bg-black text-white container h-screen w-full  justify-center items-start  flex m-auto"
      }
    >
      {loading ? (
        <h2>Loading...</h2>
      ) : !error ? (
        <div className="flex gap-4 m-10  p-14 rounded-lg flex-col">
        ...
        <div className="flex gap-4 m-10  p-14 rounded-lg flex-col">
          ...
          <a
            href={`/VerifyTokenEmail/${token.id}`}
            class="middle flex items-center justify-center none center mr-3 rounded-lg border border-pink-500 font-sans text-xs font-bold uppercase text-pink-500 transition-all hover:opacity-75 focus:ring focus:ring-pink-200 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
            data-ripple-dark="true"
          >
            Refresh
